...
export class SliderBox extends Component {
  constructor(props) {
   ...
   console.log("Slider_Box.images on sliderbox",props.firstItem, props.images)
  }

  componentDidMount() {
    this.setState({currentImage:this.props.firstItem })
      ...
      >
        ...
        >
          {!this.checkVideoExtension(extension) ?
            ...
            //   {...this.props}
            // /> :
           <View style={{backgroundColor:'black',borderRadius:6}}>
             <Image style={{ height:windowHeight-200,
        
               resizeMode:'contain',
           
                width:windowWidth-20,}} source={{uri:item}}></Image>
           </View>
:
            <View style={[
              {
    ...
    return (
      <View>
        <Carousel
          ...
          firstItem={this.state.currentImage}
          //firstItem={6}
          // {...this.props}
        />
